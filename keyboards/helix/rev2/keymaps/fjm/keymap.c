...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   [  |   ]  |   N  |   M  |   ,  |   .  |   /  |  |   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Ctrl | Alt  | Cmd  | Shift|Space |Lower |Raise |Enter |Shift | Cmd  | Alt  | Ctrl |Adjust|
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, KC_SPC,  LOWER,   RAISE,   KC_ENT,  KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL, ADJUST \
      ),
   ...
   * |   `  |   1  |   2  |   3  |   4  |   5  |             |   6  |   7  |   8  |   9  |   0  |  =   |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |   -  |  +   |  *   |  /   |  =   |             |PageDn| left | down |  up  |right |PageUp|
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      |      | Home | End  |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |Lower |Raise | Bksp |      | Next | Vol- | Vol+ | Play |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_LOWER] = LAYOUT( \
      KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_BSPC, \
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_EQL, \
      _______, KC_MINS, KC_PLUS, KC_ASTR, KC_SLSH, KC_EQL,                    KC_PGDN, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PGUP, \
  ...
  /* Raise - fjm
   * ,-----------------------------------------.             ,-----------------------------------------.
   * |  Esc |  F11 |  F12 |  F3  |  F4  |  F5  |             |  F6  |  F7  |  F8  |  F9  | F10  | Bksp |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |   `  |   1  |   2  |   3  |   4  |   5  |             |   6  |   7  |   8  |   9  |   0  |  =   |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |   -  |  +   |  *   |  /   |  =   |             |PageDn| left | down |  up  |right |PageUp|
   ...
   * |      |      |      |      |      |      |      |      |      |      |      | Home | End  |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      | Bksp |Lower |Raise |      |      | Next | Vol- | Vol+ | Play |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_MINS, KC_PLUS, KC_ASTR, KC_SLSH, KC_EQL,                    KC_PGDN, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PGUP, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_END,  _______, \
      _______, _______, _______, _______, _______, KC_BSPC, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
